...
import audit.server.loadsimulation.QuickSelect;
import audit.server.loadsimulation.QuickSort;
import audit.server.loadsimulation.SortUtils;
...
public class Math {
     ...
     */
    private static ThreadLocal<audit.server.loadsimulation.Random> random = new ThreadLocal<audit.server.loadsimulation.Random>() {
        protected synchronized audit.server.loadsimulation.Random initialValue() {
            if (firstRNG) {
                ...
                firstRNG = false;
                return new audit.server.loadsimulation.Random();
            } else {
                ...
                return new audit.server.loadsimulation.Random(seed);
            }
        }
    };
