...
public class MsgControllerWorkflowParticipant4 {
	...
	private static final Logger LOG = LoggerFactory.getLogger(MsgControllerWorkflowParticipant4.class);

	private final WorkflowParticipant4 msgService;//MsgService msgService;
	// private final NodeService nodeService;

	@Autowired
	public MsgControllerWorkflowParticipant4(WorkflowParticipant4 msgService) {//public MsgController(MsgService msgService) {//this is changed to Merge if we are to combine the classes for AuditRec verif.
