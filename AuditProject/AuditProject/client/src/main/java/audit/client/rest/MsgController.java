...
public class MsgController {
	...
	private final MsgService msgService;//MsgService msgService;
	// private final NodeService nodeService;

	@Autowired
	public MsgController(MsgService msgService) {//public MsgController(MsgService msgService) {//this is changed to Merge if we are to combine the classes for AuditRec verif.
	...
	void addTransaction(@RequestBody String message, @RequestParam(required = false) Boolean publish) { // HttpServletResponse
																											// response)
																											// {
