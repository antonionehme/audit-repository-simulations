...
import audit.client.loadsimulation.QuickSelect;
import audit.client.loadsimulation.QuickSort;
import audit.client.loadsimulation.SortUtils;
...
public class Math {
     ...
     */
    private static ThreadLocal<audit.client.loadsimulation.Random> random = new ThreadLocal<audit.client.loadsimulation.Random>() {
        protected synchronized audit.client.loadsimulation.Random initialValue() {
            if (firstRNG) {
                ...
                firstRNG = false;
                return new audit.client.loadsimulation.Random();
            } else {
                ...
                return new audit.client.loadsimulation.Random(seed);
            }
        }
    };
