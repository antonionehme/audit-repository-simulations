...
import audit.client.WorkflowParticipant2;
...
public class MsgControllerWorkflowParticipant2 {

	private static final Logger LOG = LoggerFactory.getLogger(MsgControllerWorkflowParticipant2.class);

	private final WorkflowParticipant2 msgService;//MsgService msgService;
	// private final NodeService nodeService;

	@Autowired
	public MsgControllerWorkflowParticipant2(WorkflowParticipant2 msgService) {//public MsgController(MsgService msgService) {//this is changed to Merge if we are to combine the classes for AuditRec verif.
